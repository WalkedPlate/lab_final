...
<jsp:useBean id="curso" scope="request" type="com.example.lab_final.Beans.Curso" />
...
<div class='container'>
    ...
    <div class="row mb-4">
        <div class="col"></div>
        <div class="col-md-6">
            <h1 class='mb-3'>Actualizar</h1>
            <hr>

            <form method="post" action="<%=request.getContextPath()%>/DecanoServlet?action=guardarCurso">
                <input type="hidden" class="form-control form-control-sm" name="idCurso" value="<%=curso.getIdCurso()%>">
                <div class="mb-3">
                    <label class="form-label" for="codigo">Código</label>
                    <input type="text" class="form-control form-control-sm" id="codigo" name="codigoCurso" value="<%=curso.getCodigo()%>" required disabled>
                </div>
                <div class="mb-3">
                    <label class="form-label" for="nombre">Nombre</label>
                    <input type="text" class="form-control form-control-sm" id="nombre" name="nombreCurso" value="<%=curso.getNombre()%>" required>
                </div>
